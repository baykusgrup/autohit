        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <ul>
                    ...
                    <li><b><?php echo lang("myinfo_ScriptLanguage"); ?></b> <?php if (isset($myinfoip["scriptdili"])) { echo $myinfoip["scriptdili"]; }?></li>
                    ...
                    <li><b><?php echo lang("myinfo_PreviousPage"); ?></b> <?php if (isset($myinfoip["oncekisayfa"])) { echo $myinfoip["oncekisayfa"]; }?></li>

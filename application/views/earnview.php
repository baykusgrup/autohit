            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result == "1") {
                        ...
                        url = theurls[0].urls_g;
                        window.open(url, "myWindow");
                        urlLast.push("<li>" + url + "<a id='blockedStatus_" + theurls[0].site_id + "' onclick='getBlocked(" + theurls[0].site_id + ");'>Block</a></li>");
                        ...
                        var counter = theurls[0].durations;
                        ...
                        timerId = setTimeout(function () {
                            beginu();
                            controllSurfCredit(theurls[0].site_id);
                        }, theurls[0].durations * 1000);


                        //setTimeout(calculateCost(theurls[0].site_id), theurls[0].durations * 1000);
                    }
                }

            });

            //document.getElementById("duration_time").innerHTML = theurls[0].durations;
